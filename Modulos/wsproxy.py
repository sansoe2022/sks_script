...
class ConnectionHandler(threading.Thread):
    def __init__(self, socClient, server, addr):
        ...
        self.client_buffer = b''  # Bytes handling in Python 3
        self.server = server
    ...
    def findHeader(self, head, header):
        aux = head.find(header.encode() + b': ')  # Handling bytes
    ...
    def method_CONNECT(self, path):
        ...
        self.client.sendall(RESPONSE.encode())  # Encode RESPONSE as bytes
...
def main(host=LISTENING_ADDR, port=LISTENING_PORT):
    ...
    print("\033[0;34m━" * 10, "\033[1;32m SSHPLUS", "\033
